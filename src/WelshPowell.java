...
public class WelshPowell {
    ...
    public void readGraphFromFile(String filePath) {
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            System.out.println("Graphe charge avec " + numVertices + " sommets.");
    ...
    public void welshPowell() {
        ...
        while (coloredCount < numVertices) {
            ...
            // Passer à la couleur suivante pour la prochaine
            currentColor++;
        }
    ...
    private void displayResults(int totalColors) {
        ...
        System.out.println("Nombre chromatique trouv : " + totalColors);
        for (Tri v : vertices) {
